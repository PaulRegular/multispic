...
While intrinsic rates of growth may vary across species, this formulation implies that the growth of all species is ultimately limited by the finite amount of energy in a region. Combining equations \@ref(eq:pro), \@ref(eq:obs), and \@ref(eq:ms-logistic), our model becomes
...
...next describe errors and note covariate options (note that covarate option for r was not implemented as this is a long-term vital rate shaped by natural selection).
