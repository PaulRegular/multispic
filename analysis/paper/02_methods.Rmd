...
The multispecies production model described above requires two basic inputs for one or more species in a region: 1) a time-series of catch ($C_{y,s}$ in equation \@ref(eq:ms-pro)), and 2) an index of population size ($I_{y,s}$ in equation \@ref(eq:ms-obs)). The Northwest Atlantic Fisheries Organization (NAFO) and Fisheries and Oceans Canada (DFO) has been collecting and curating such information for multiple fish populations along the shelves of Newfoundland and Labrador since the 1970s. 

Given the availability of data, the presence of regions with distinct productivity and a reasonably well defined marine community [i.e. ecosystem production units; @pepin2014], ...also note something about dynamic history of the fisheries in the region...and these factors make this a good area for a case study...cross-ref Rick's map.


Multiple demersal fish populations have been commercially exploited since the colonization of 

Fisheries and Oceans Canada has actively surveyed fish populations along the shelves of Newfoundland and Labrador since the early 1970s. Many of these populations, such as Atlantic cod *Gadus morhua*, were commercially exploited long before the commencement of the survey

History of survey reference [@chadwick2007]
