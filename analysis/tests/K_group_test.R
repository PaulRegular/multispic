...
spp_fit <- multispic(inputs, species_cor = "one", temporal_cor = "ar1",
...
list2env(nl_inputs_and_priors(region = "3LNO", species = NULL,
...
sp_fit <- multispic(inputs, species_cor = "none", temporal_cor = "none",
                    ...
                    pe_covariates = ~0, K_covariates = ~0, start_par = start_par)
