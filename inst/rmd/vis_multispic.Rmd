...
`r if (n_covar >= 1) "> Includes covariate effects"`
...
`r if (n_covar >= 1) "> Standardized process error = residual process error, in log space, not explained by the covariate effects divided by the standard deviation of the process." else "> Standardized process error = process error, in log space, divided by the standard deviation of the process."`
...
`r if (n_spp_cor > 1 && n_covar >= 1) "> Represents correlation in residual process error not explained by the covariate effects."`
