...
```{r, eval = n_time_cor == 1}
plot_post(prior_mean = fit$tmb_data$mean_logit_phi,
          prior_sd = fit$tmb_data$sd_logit_phi,
...
```{r, eval = n_covar > 1}
plot_post(prior_mean = fit$tmb_data$mean_pe_betas,
          prior_sd = fit$tmb_data$sd_pe_betas,
