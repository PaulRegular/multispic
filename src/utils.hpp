...
//Returns log(exp(log(pnorm(x+upper)))-exp(log(pnorm(x-lower)))) but in a much more computationally stable way.
...
// Leverage the censored bounds functions to create an approximation of duniform
